        ...
        >
          ...
          <Card sx={{ width: 345, marginBottom: 5 }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" sx={{ color: "black" }}>
                A field that applies principles of numbers, structure, and
                patterns to solve problems in various scientific, engineering,
          ...
          <Card sx={{ width: 345, marginBottom: 5 }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" sx={{ color: "black" }}>
                A field that uses systematic observation, experimentation, and
                analysis to explore and understand natural phenomena, advancing
          ...
          <Card sx={{ width: 345, marginBottom: 5 }}>
            ...
            <CardContent>
              ...
              <Typography variant="body2" sx={{ color: "black" }}>
                This is something that we at Smart Study focus on. Equip
                yourself with essential tools for success, including coding
                practice resources, resume templates, and job application tips.
              </Typography>
            </CardContent>
            <CardActions>
              <Button size="small">
